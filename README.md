...
print(f"Player's car location: ({car_location_x}, {car_location_y}, {car_location_z})")
...
print(f"Player's team index: {player_team_index}")
print(f"Team score: {team_info.score}")



# Accessing the game tick packet to print ball location
print("Ball location: X =", game_tick_packet.game_ball.physics.location.x,
...
print("First player name:", first_player.name)
print("Boost amount:", first_player.boost)
print("Car position:", first_player.physics.location.x, first_player.physics.location.y, first_player.physics.location.z)
```
---
...
print(f"Distance to the ball: {distance_to_ball} units")
```
---
...
class plugin_Get_Ball_xyz:
    ...
    def Name(self):
        return "Ball location print"
    
    def Description(self):
        return "Constantly prints the ball location!"
    
    def Author(self):
        return "Created by User782"
    ...
    def main(self):
        ...
        while True:
            try:
                ...
                # Check if the game_tick_packet is set before proceeding
                if self.game_tick_packet:
                    time.sleep(10)
                    # Accessing the game tick packet to print ball location
                    print("Ball location: X =", self.game_tick_packet.game_ball.physics.location.x,
                       "Y =", self.game_tick_packet.game_ball.physics.location.y,
                       "Z =", self.game_tick_packet.game_ball.physics.location.z)
